...
def build_lumimask(filename):
    ...
    with importlib.resources.path("src.hbb.data", filename) as path:
        return LumiMask(path)

lumiMasks = {
    '2016APV': build_lumimask('Cert_271036-284044_13TeV_23Sep2016ReReco_Collisions16.json'),
    '2016': build_lumimask('Cert_271036-284044_13TeV_23Sep2016ReReco_Collisions16.json'),
    '2017': build_lumimask('Cert_294927-306462_13TeV_EOY2017ReReco_Collisions17_v1.json'),
    '2018': build_lumimask('Cert_314472-325175_13TeV_17SeptEarlyReReco2018ABC_PromptEraD_Collisions18.json'),
